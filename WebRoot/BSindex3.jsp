...
<div class="gong" id="x3">
  <div class="con">
    ...
    <div class="form">
      ...
      <!-- 设置一个隐藏域 -->
      <input type="hidden" name="uid" value="${buser.uid}">
      
        <div class="add">
          <span class="add_tit">用户名 ：</span>
          <span class="add_text"><input type="text" name="username" id="username" value="${buser.username}" /></span>
        </div>

        <div class="add">
          <span class="add_tit">邮箱 ：</span>
          <span class="add_text"><input type="text" name="email" id="email" value="${buser.email}" /></span>
        </div>

        <div class="add">
          <span class="add_tit">手机 ：</span>
          <span class="add_text"><input type="text" name="tel" id="tel" value="${buser.tel}" /></span>
        </div>

        <div class="add">
          <span class="add_tit">密码 ：</span>
          <span class="add_text"><input type="text" name="password" id="password" value="${buser.password }" /></span>
        </div>
