...
<div class="con">
  <div class="box">
    ...
    <div class="text">
      ...
      <form action="/fruits/user/RegistServlet" method="post" id="regForm">
              <div class="text_box">
                  ...
                  <input type="text" name="tel" id="phone" value="" onblur="isPhone()"/>
                  <div id="isPhone" class="iss"></div>
                  </div>
                  <div class="main"><div class="name">密码：</div>
                  <input type="password" name="password" id="pwd1" value="" onblur="isPwd1()"/>
                  <div id="isPwd1" class="iss"></div>
                  </div>
                  <div class="main"><div class="name">确定密码：</div>
                  <input type="password" name="repassword" id="pwd2" value="" onblur="isPwd2()"/>
